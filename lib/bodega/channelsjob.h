...
#ifndef BODEGA_CHANNELSJOB_H
#define BODEGA_CHANNELSJOB_H
...
namespace Bodega {
    ...
    class BODEGA_EXPORT ChannelsJob : public NetworkJob
    {
        Q_OBJECT
        Q_PROPERTY(int pageSize READ pageSize)
        Q_PROPERTY(int offset READ offset)
    public:
        ChannelsJob(const QString &channelId, QNetworkReply *reply,
                    Session *parent);
        ~ChannelsJob();
