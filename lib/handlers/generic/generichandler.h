...
namespace Bodega {
    ...
    class GenericHandler : public AssetHandler
    {
        Q_OBJECT
        Q_INTERFACES(Bodega::AssetHandler)

    public:
        GenericHandler(QObject *parent = 0);
        ~GenericHandler();
    ...
    private:
        QWeakPointer<GenericInstallJob> m_installJob;
        QWeakPointer<GenericUninstallJob> m_uninstallJob;
